<?php
/**
 * CRON PARA BACKUP AUTOMATICO POR HORA
 * Ejecuta backup de tablas POS cada hora
...
try {
    ...
    if ($resultado['success']) {
        $logEntry .= 'EXITO: ' . $resultado['total'] . ' tablas respaldadas';
    } else {
        $logEntry .= 'ERROR: ' . implode(', ', $resultado['errores']);
    }
    $logEntry .= "\n";
