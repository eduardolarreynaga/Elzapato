...
<aside class="sidebar">
    <div class="sidebar-header">
        <button class="sidebar-close" type="button" aria-label="Cerrar menu lateral">
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <li class="<?php echo $activeMenu === 'productos' ? 'active' : ''; ?>">
                <a href="productos.php"><i class="fas fa-boxes"></i><span>Inventario</span></a>
            </li>
            <li class="<?php echo $activeMenu === 'ventas' ? 'active' : ''; ?>">
                <a href="ventas.php"><i class="fas fa-shopping-cart"></i><span>Ventas</span></a>
            </li>
            <li class="<?php echo $activeMenu === 'clientes' ? 'active' : ''; ?>">
                <a href="clientes.php"><i class="fas fa-users"></i><span>Clientes</span></a>
            </li>
            <li class="<?php echo $activeMenu === 'empleados' ? 'active' : ''; ?>">
                <a href="empleados.php"><i class="fas fa-user-tie"></i><span>Empleados</span></a>
            </li>
            <li class="<?php echo $activeMenu === 'proveedores' ? 'active' : ''; ?>">
                <a href="proveedores.php"><i class="fas fa-truck"></i><span>Proveedores</span></a>
            </li>
            <li class="<?php echo $activeMenu === 'reportes' ? 'active' : ''; ?>">
                <a href="reportes.php"><i class="fas fa-chart-line"></i><span>Reportes</span></a>
            </li>
            <li class="<?php echo $activeMenu === 'caja' ? 'active' : ''; ?>">
                <a href="caja.php"><i class="fas fa-cash-register"></i><span>Caja</span></a>
            </li>
            <li class="<?php echo $activeMenu === 'historial' ? 'active' : ''; ?>">
                <a href="historial.php"><i class="fas fa-history"></i><span>Historial</span></a>
            </li>
            <li class="<?php echo $activeMenu === 'backup' ? 'active' : ''; ?>">
                <a href="backup.php"><i class="fas fa-database"></i><span>Respaldos</span></a>
            </li>
            <li class="<?php echo $activeMenu === 'configuracion' ? 'active' : ''; ?>">
    ...
    <div class="sidebar-footer">
        <div class="user-info-container">
            <div class="user-info">
                <i class="fas <?php echo $userRole === 'admin' ? 'fa-user-shield' : 'fa-user'; ?>"></i>
                <div>
