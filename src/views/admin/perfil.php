...
$_SESSION['user_role'] = $_SESSION['rol'] ?? $_SESSION['user_role'] ?? 'admin';
    ...
    <main class="profile-page">
        <section class="profile-card">
            <div class="profile-header">
                ...
                <div>
                    <h1>Mi Perfil</h1>
                    <p>Panel personal del administrador.</p>
                </div>
            </div>
            ...
            <div class="profile-actions">
                <a class="btn-primary" href="/ElZapato/src/views/admin/dashboard.php">Ir al dashboard</a>
